...
test('converter: a valid timezone gives an offset', function (t) {
  var tz1 = '2017-01-01T02:00:00+05:00'
  var expected1 = -300
  var tz2 = '-05:00'
  var expected2 = 300
...
test('converter: no timezone returns local value', function (t) {
  var noTz = '2017-01-01T02:00:00'
  t.equal(timezoneShift(noTz).offset, new Date().getTimezoneOffset())
  t.end()
})
...
test('converter: converting from a negative timezone', function(t) {
  var tz = '-03:00'
  var testDateStr = '2017-01-01T02:00:00-03:00'
  var expectedHours = 2
  var expectedDate = new Date('2017-01-01T02:00:00')
...
test('converter: converting to a negative timezone', function(t) {
  var tz = '-03:00'
  var testDateStr = new Date('2017-01-01T02:00:00')
  var expectedDate = new Date('2017-01-01T02:00:00-03:00')
...
test('converter: converting to a positive timezone', function(t) {
  var tz = '+04:00'
  var testDateStr = '2017-01-01T02:00:00'
  var expectedDate = new Date('2017-01-01T02:00:00+04:00')
